...
from src.rete.algorithm import Strategy
from src.rete.algorithm.Strategy import DepthStrategy, BreadthStrategy, RandomStrategy, ComplexityStrategy, \
    SimplicityStrategy, NaiveLexStrategy, NaiveMeaStrategy
